...
{ // hotfix
	...
	status.push({
		name: '赤明野',
		// cate: '其它',
		desc: '領域內友方主動攻擊攜帶「燃燒」的目標時，「對戰中」傷害和暴擊率提高 4/6/8/10%。領域內友方法術免傷、暴擊抗性提高 10/13/16/20%，遭受法術攻擊後，驅散自身領域內友方 2 個「有害狀態」。（領域內友方遭受法術攻擊後移除，自身所有絕學冷卻時間-1，並對攻擊者施加「疲弱I」狀態，持續 2 回合）',
		'驅': false,
		'擴': false,
		'偷': false,
	})
