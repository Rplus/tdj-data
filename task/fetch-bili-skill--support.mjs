...
support_skills['liyou'] = {
	'owner': '黎幽',
	'owner_pinyin': 'liyou',
	'support_skill': {
		'name': '荊棘蓮華·援',
		'img': 'https://cdn.imgchest.com/files/6c37fcb05ecc.png',
		'type': '法攻傷害',
		'cd': '3回合',
		'shoot': '自身',
		'range': '菱形4格',
		'descs': [
			{
				'star': '4',
				'desc': '[共勢]全場友方「咒師」職業，與攜帶「有害狀態」角色作戰時，「對戰中」法攻，免傷提高5%。\n[主動]對範圍內所有敵人造成0.4倍傷害，施加2個隨機「有害狀態」，對「咒師」和「祝由」額外施加「封咒」「降療I」狀態，持續2回合。\n若自身為「咒師」職業，絕學後對3格範圍敵方施加1個隨機「有害狀態」，自身獲得「獄魂」狀態。\n「獄魂」：主動攻擊「對戰前」施加「幽闕」狀態，持續2回合，若目標身上已攜帶2個及以上「有害狀態」，則施加「暈眩」狀態，持續1回合。（主動攻擊「對戰後」移除）'
			},
			{
				'star': '5',
				'desc': '[共勢]全場友方「咒師」職業，與攜帶「有害狀態」角色作戰時，「對戰中」法攻，免傷提高7%。\n[主動]對範圍內所有敵人造成0.4倍傷害，施加2個隨機「有害狀態」，對「咒師」和「祝由」額外施加「封咒」「降療I」狀態，持續2回合，對其他職業施加2層「疫瘴」狀態。\n若自身為「咒師」職業，絕學後對3格範圍敵方施加2個隨機「有害狀態」，自身獲得「獄魂」狀態。\n「獄魂」：主動攻擊「對戰前」施加「幽闕」狀態，持續2回合，若目標身上已攜帶2個及以上「有害狀態」，則施加「暈眩」狀態，持續1回合。（主動攻擊「對戰後」移除）'
			}
		]
	}
};

support_skills['shangguanyuan'] = {
	'owner': '上官遠',
	'owner_pinyin': 'shangguanyuan',
	'support_skill': {
		'name': '列陣待發·援',
		'img': 'https://cdn.imgchest.com/files/4aee034638be.png',
		'type': '主動',
		'cd': '2回合',
		'shoot': '自身',
		'range': '菱形3格',
		'descs': [
			{
				'star': '4',
				'desc': '[共勢]全場友方「鐵衛」職業，行動結束時，3格範圍內每有1名友方，恢復自身6%氣血（最多恢復30%）（每回合觸發1次）\n[主動]主動使用，範圍內所有友方獲得「披甲I」「辟防」狀態，持續3回合。\n若自身為「鐵衛」職業，額外獲得「戒備」狀態，持續3回合。\n「戒備」：物防和反擊傷害+30%，受到傷害後消失，狀態消失時移除自身3格範圍內友方所有「移動力降低」的狀態，施加「奮起」狀態，持續2回合。\n「奮起」：移動力+1，免疫「移動力降低」'
			},
			{
				'star': '5',
				'desc': '[共勢]全場友方「鐵衛」職業，行動結束時，3格範圍內每有1名友方，恢復自身8%氣血（最多恢復40%）（每回合觸發1次）\n[主動]主動使用，範圍內所有友方獲得「神護II」「披甲I」「辟防」狀態，持續3回合。\n若自身為「鐵衛」職業，額外獲得「戒備」「復仇」狀態，持續3回合。\n「戒備」：物防和反擊傷害+30%，受到傷害後消失，狀態消失時移除自身3格範圍內友方所有「移動力降低」的狀態，施加「奮起」狀態，持續2回合。\n 「奮起」：移動力+1，免疫「移動力降低」'
			}
		]
	}
};

support_skills['fangyun'] = {
	'owner': '方芸',
	'owner_pinyin': 'fangyun',
	'support_skill': {
		'name': '電鎖雷吟·援',
		'img': 'https://cdn.imgchest.com/files/97a58cf0ff1e.png',
		'type': '物攻傷害',
		'cd': '3回合',
		'shoot': '自身',
		'range': '直線6格',
		'descs': [
			{
				'star': '4',
				'desc': '[共勢]全場友方「羽士」職業，暴擊率、暴擊傷害提高3%，與非女性角色作戰時，暴擊率、暴擊傷害額外提高3%。\n[主動]對範圍內所有敵人造成0.4倍傷害，並使其發生1格內「擾動」效果，施加「電流」狀態，持續2回合。若目標為非女性角色額外施加「迷心」狀態，持續2回合。\n若自身為「羽士」職業，絕學後自身獲得「括羽」狀態。\n「迷心」：行動結束對自身以及周圍1圈友方造成「固定傷害」（目標最大氣血*25%）（有害狀態，不可驅散）'
			},
			{
				'star': '5',
				'desc': '[共勢]全場友方「羽士」職業，暴擊率、暴擊傷害提高5%，與非女性角色作戰時，暴擊率、暴擊傷害額外提高5%。\n[主動]對範圍內所有敵人造成0.4倍傷害，並使其發生1格內「擾動」效果，施加「電流」狀態，持續2回合。若目標為非女性角色額外施加「迷心」「亂神II」狀態，持續2回合。\n若自身為「羽士」職業，絕學後自身獲得「括羽」「隙影」狀態。\n「隙影」：主動攻擊若造成擊殺，該絕學冷卻時間減少3回合（主動攻擊後移除）。'
			}
		]
	}
};
